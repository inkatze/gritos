		...
		<div class='footer_txt'>
			<div class='container'>
				...
				<?php /* 
					...
					You can buy this theme without footer links online at http://smthemes.com/buy/cinemalounge/
				*/ ?>
				<div class='smthemes'>Designed by <a href='http://asd.pm' target='_blank'>Online games</a>, thanks to: <a href='http://www.boxintense.com/' target='_blank'>Managed Hosting</a>, <a href='http://www.linkslive.info/' target='_blank'>Business Web Directory</a> and <a href='http://lizardthemes.com/frau/' target='_blank'>WordPress theme free</a></div>
			</div>
		</div>
		<?php wp_footer(); ?>
